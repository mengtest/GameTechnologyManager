...
<html>
  <head>
    ...
    <title>My JSP 'userAllBlog.jsp' starting page</title>
...
<script type="text/javascript" src="<%=basePath%>js/blog.js"></script>
  ...
  <body>
    <table id="dg" class="easyui-datagrid" title="所有文章"
		...
		data-options="rownumbers:true,singleSelect:true,pagination:true,collapsible:true,url:'blog/getAllBlogs/0',method:'get',toolbar:toolbar">
		<thead>
			<tr>
